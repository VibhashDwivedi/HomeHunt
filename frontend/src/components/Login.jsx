  ...
  return (
        <div className='bg-login'>
          <div className='d-flex justify-content-center align-items-center vh-100'>
            <div className='card login-card card-shadow-lg mb-5 w-25' style={{width:'350px'}}>
              <div className='card-body py-3 px-5 login'>
              <i className='fa-solid fa-lock fa-2x d-block text-center' style={{color:"white"}}></i>
           ...
           <i className="fa-solid fa-envelope fa-2x me-3" style={{color:"white"}}></i>
                    ...
                    <input type='' className='form-control mb-2 p-2' id='Email' placeholder='Enter email'  name="email" onChange={loginForm.handleChange} value={loginForm.values.email}/>
                    </div>
...
function(){
  ...
  if (x.type === "password") {
    ...
    <button type='submit' className='btn btn-info w-75 rounded-5 mt-2 mb-1'>LOG IN</button>
</div>
                </form>
     ...
     */}
     ...
     <Link to="/signup"  className="d-flex justify-content-center text-decoration-none">
